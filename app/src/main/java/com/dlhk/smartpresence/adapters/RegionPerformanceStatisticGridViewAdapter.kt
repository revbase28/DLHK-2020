...
class RegionPerformanceStatisticGridViewAdapter(
    val context: Context,
    val statisticData: List<DataRegionPerformanceStatistic>
): BaseAdapter() {

    init {
        Log.d("GV Performance", "Adapter Attached")
    }
    ...
    override fun getView(position: Int, view: View?, viewGroup: ViewGroup): View {
        ...
        vh.apply {
            ...
            cardContainer.setOnClickListener {
                val intent = Intent(context, ZonePerformanceStatisticActivity::class.java).apply {
