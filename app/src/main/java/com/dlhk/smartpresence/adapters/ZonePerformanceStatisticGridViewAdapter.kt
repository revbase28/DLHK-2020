...
import com.dlhk.smartpresence.ui.smart_presence.individual_performance_statistic.IndividualPerformanceStatisticActivity
import com.dlhk.smartpresence.ui.smart_presence.zone_presence_statistic.ZoneOnRegionPresenceStatisticActivity
import com.norbsoft.typefacehelper.TypefaceHelper

class ZonePerformanceStatisticGridViewAdapter(
    val context: Context,
    val statisticData: List<DataZonePerformanceStatistic>
): BaseAdapter() {
    ...
    override fun getView(position: Int, view: View?, viewGroup: ViewGroup): View {
        ...
        vh.apply {
            ...
            textRegion.text = statisticData[position].codeZone
            cardContainer.setOnClickListener {
                val intent = Intent(context, IndividualPerformanceStatisticActivity::class.java).apply {
                    putExtra("zoneName", statisticData[position].codeZone)
