...
import kotlinx.android.synthetic.main.fragment_assesment_drainage_head.*


class DrainageHeadAssesmentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_assesment_drainage_head, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        send.setOnClickListener {
            ...
            if(verifyInput(disciplinePresence, reportI, reportII, reportIII, cleanliness, completeness, garbageData)){
                ...
                Utility.showLoadingDialog(childFragmentManager, "Loading Drainage Head")
                viewModel.postHeadOfZoneAssessment(presenceId, cleanliness, completeness, garbageData, disciplinePresence, reportI, reportII, reportIII, "drainage")
    ...
    private fun getZoneLeaderFromApi(regionName: String){
        Utility.showLoadingDialog(childFragmentManager, "Loading ZH Drainage")
